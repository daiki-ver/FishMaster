...
Shader "Hidden/Underwater" {
	...
	v2f vert (appdata_img v) {
		...
		o.uv01 =  v.texcoord.xyxy + offsets.xyxy * float4(1,1, -1,-1) * 0 * _MainTex_TexelSize.xyxy;
		o.uv23 =  v.texcoord.xyxy + offsets.xyxy * float4(1,1, -1,-1) * 0 * _MainTex_TexelSize.xyxy;
		o.uv45 =  v.texcoord.xyxy + offsets.xyxy * float4(1,1, -1,-1) * 0 * _MainTex_TexelSize.xyxy;
